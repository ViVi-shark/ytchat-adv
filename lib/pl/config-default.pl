...
our %games = (
  'sw2' => {
    ...
    'faces' => 6,
    'tooltips' => [
        {'隠蔽判定' => '<b>隠蔽判定</b><br>基準値： スカウト or レンジャー＋器用度ボーナス<br>（技巧パッケージ）<br>所要時間： １分'},
        {'応急手当判定' => '<b>応急手当判定</b><br>基準値： レンジャー＋器用度ボーナス<br>（レンジャー技巧パッケージ）<br>所要時間： 10分'},
        {'解除判定' => '<b>解除判定</b><br>基準値： スカウト or レンジャー（自然環境かつ自然物）＋器用度ボーナス<br>（技巧パッケージ）<br>所要時間： １分'},
        {'スリ判定' => '<b>スリ判定</b><br>基準値： スカウト＋器用度ボーナス<br>（スカウト技巧パッケージ）<br>所要時間： 10秒'},
        {'変装判定' => '<b>変装判定</b><br>基準値： スカウト＋器用度ボーナス<br>（スカウト技巧パッケージ）<br>所要時間： 10分'},
        {'罠設置判定' => '<b>罠設置判定</b><br>基準値： スカウト or レンジャー（自然環境かつ自然物）＋器用度ボーナス<br>（技巧パッケージ）<br>所要時間： 10分'},
        {'受け身判定' => '<b>受け身判定</b><br>基準値： スカウト or レンジャー＋敏捷度ボーナス<br>（運動パッケージ）<br>所要時間： 一瞬'},
        {'隠密判定' => '<b>隠密判定</b><br>基準値： スカウト or レンジャー＋敏捷度ボーナス<br>（運動パッケージ）<br>所要時間： １分'},
        {'軽業判定' => '<b>軽業判定</b><br>基準値： スカウト or レンジャー＋敏捷度ボーナス<br>（運動パッケージ）<br>所要時間： １分'},
        {'登攀判定' => '<b>登攀判定</b><br>技能： スカウト or レンジャー or 冒険者<br>能力値ボーナス： 敏捷（スカウト・レンジャー）／筋力（冒険者）<br>パッケージ： 運動（スカウト・レンジャー）／－（冒険者）<br>所要時間： １分<br>※詳細⇒『Ⅰ』122頁'},
        {'尾行判定' => '<b>尾行判定</b><br>基準値： スカウト or レンジャー＋敏捷度ボーナス<br>（運動パッケージ）<br>所要時間： 10分'},
        {'足跡追跡判定' => '<b>足跡追跡判定</b><br>基準値： スカウト or レンジャー or ライダー【探索指令】＋知力ボーナス<br>（観察パッケージ）<br>所要時間： １分'},
        {'異常感知判定' => '<b>異常感知判定</b><br>基準値： スカウト or レンジャー（自然環境） or ライダー【探索指令】＋知力ボーナス<br>（観察パッケージ）<br>所要時間： 一瞬'},
        {'聞き耳判定' => '<b>聞き耳判定</b><br>基準値： スカウト or レンジャー＋知力ボーナス<br>（観察パッケージ）<br>所要時間： 10秒'},
        {'危険感知判定' => '<b>危険感知判定</b><br>基準値： スカウト or レンジャー or ライダー【探索指令】＋知力ボーナス<br>（観察パッケージ）<br>所要時間： 一瞬'},
        {'見識判定' => '<b>見識判定</b><br>基準値： セージ or アルケミスト＋知力ボーナス<br>（知識パッケージ）<br>所要時間： 一瞬'},
        {'探索判定' => '<b>探索判定</b><br>基準値： スカウト or レンジャー（自然環境） or ライダー【探索指令】＋知力ボーナス<br>（観察パッケージ）<br>所要時間： 10分'},
        {'地図作成判定' => '<b>地図作成判定</b><br>基準値： スカウト or レンジャー（自然環境） or セージ or ライダー＋知力ボーナス<br>パッケージ： 観察（スカウト・レンジャー）／知識（セージ・ライダー）<br>所要時間： 10分'},
        {'天候予測判定' => '<b>天候予測判定</b><br>基準値： スカウト or レンジャー＋知力ボーナス<br>（観察パッケージ）<br>所要時間： １分'},
        {'病気知識判定' => '<b>病気知識判定</b><br>基準値： レンジャー or セージ＋知力ボーナス<br>パッケージ： 観察（レンジャー）／知識（セージ）<br>所要時間： 10分'},
        {'文献判定' => '<b>文献判定</b><br>基準値： セージ or アルケミスト＋知力ボーナス<br>（知識パッケージ）<br>所要時間： 10分'},
        {'文明鑑定判定' => '<b>文明鑑定判定</b><br>基準値： セージ＋知力ボーナス<br>（セージ知識パッケージ）<br>所要時間： 10分'},
        {'宝物鑑定判定' => '<b>宝物鑑定判定</b><br>基準値： スカウト（価値のみ） or セージ＋知力ボーナス<br>パッケージ： 観察（スカウト）／知識（セージ）<br>所要時間： 10分'},
        {'薬品学判定' => '<b>薬品学判定</b><br>基準値： レンジャー or セージ or アルケミスト＋知力ボーナス<br>パッケージ： 観察（レンジャー）／知識（セージ・アルケミスト）<br>所要時間： １分'},
        {'罠回避判定' => '<b>罠回避判定</b><br>基準値： スカウト or レンジャー（自然環境） or ライダー【探索指令】＋知力ボーナス<br>（観察パッケージ）<br>所要時間： 一瞬'},
        {'真偽判定' => '<b>真偽判定</b><br>基準値： 冒険者＋知力ボーナス<br>所要時間： 10秒'},
        ...
        {'騎乗判定' => '<b>騎乗判定</b><br>基準値： ライダー＋敏捷度ボーナス<br>所要時間： １分'},
        {'弱点隠蔽判定' => '<b>弱点隠蔽判定</b><br>基準値： ライダー＋知力ボーナス<br>（ライダー知識パッケージ）<br>所要時間： 一瞬<br>※詳細⇒『Ⅲ』86頁'},
