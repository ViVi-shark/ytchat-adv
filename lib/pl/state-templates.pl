        ...
        'categories' => [
          ...
          },
          {
            ...
            'states' => [
              ...
              {'name' => '【クラッシュファング】Ｂ短縮', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'debuff'}, 'duration' => '1R', 'description' => '与える物理ダメージ－１'},
              {'name' => '【クラッシュファング】Ａ短縮', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'debuff'}, 'duration' => '1R', 'description' => '与える物理ダメージ－２'},
              {'name' => '【クラッシュファング】Ｓ短縮', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'debuff'}, 'duration' => '1R', 'description' => '与える物理ダメージ－４'},
              {'name' => '【クラッシュファング】SS短縮', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'debuff'}, 'duration' => '1R', 'description' => '与える物理ダメージ－10'},
              {'name' => '【クリティカルレイ】Ｂ', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'buff'}, 'duration' => '1R', 'description' => '一度だけ、武器攻撃のダメージ決定の出目＋１'},
              {'name' => '【クリティカルレイ】Ａ', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'buff'}, 'duration' => '1R', 'description' => '一度だけ、武器攻撃のダメージ決定の出目＋２'},
              {'name' => '【クリティカルレイ】Ｓ', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'buff'}, 'duration' => '1R', 'description' => '一度だけ、武器攻撃のダメージ決定の出目＋３'},
              {'name' => '【クリティカルレイ】SS', 'icon' => {'category' => 'SW2/賦術', 'direction' => 'buff'}, 'duration' => '1R', 'description' => '一度だけ、武器攻撃のダメージ決定の出目＋６'},
          ...
          },
          {
            ...
            'states' => [
              ...
              {'name' => '〈夢幻の薬〉', 'icon' => {'category' => '汎用', 'direction' => 'other'}, 'duration' => 'undefined', 'description' => '行動不能\n自然解除後、ＭＰを完全回復', 'source' => '#self'},
              {'name' => '〈ラル＝ヴェイネの肩掛け〉', 'icon' => {'category' => '汎用', 'direction' => 'buff'}, 'duration' => '1R', 'description' => '指定属性に対する生命・精神抵抗力判定＋１\n指定属性から受けるダメージ－１', 'source' => '#self'},
              {'name' => '〈ラル＝ヴェイネの肩掛け〉', 'icon' => {'category' => '汎用', 'direction' => 'buff'}, 'duration' => '1R', 'description' => '指定属性への生命・精神抵抗力判定＋１\nその属性からのダメージ－１', 'source' => '#self'},
              {'name' => '〈ラル＝ヴェイネの練魔帯〉魔力上昇', 'icon' => {'category' => '汎用', 'direction' => 'buff'}, 'duration' => '永続', 'description' => '次の魔法行使１回の魔力＋１', 'source' => '#self'},
