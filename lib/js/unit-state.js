...

        {
...

            {
                ...
                stateTemplates.forEach(
                    /** @param {{gameName: string, categories: Array<{categoryName: string, states: Array<{name: string, icon: {category: string, direction: string}, duration: string|null, description?: string|null, source?: string|null}>}>}} game */game => {
