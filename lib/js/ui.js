...
function unitAdd(unitName){
  ...
  newUnit.innerHTML = '<dt onclick="sheetSelect(\''+unitId+'\');sheetOpen();" style="color:'+unitList[unitName]['color']+';"><span class="name">'+unitName+`</span><a id="stt_unit_${unitId}_link" target="_blank"></a></dt>`;
