            ...
            function createNodes(current, groupingKeys) {
                ...
                for (const item of array) {
                    if (item instanceof TrackGroup) {
                        ...
                        function createIconNode(className, iconName) {
                            const iconNode = document.createElement('span');
                            iconNode.classList.add('material-symbols-outlined', 'icon', className);
                            iconNode.textContent = iconName;
                            return iconNode;
                        }

                        trackNode.appendChild(createIconNode('icon-default', 'audio_file'));
                        trackNode.appendChild(createIconNode('icon-already-played', 'done'));
