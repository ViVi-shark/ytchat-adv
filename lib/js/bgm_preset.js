            ...
            function createNodes(current, groupingKeys){
                ...
                for (const item of array) {
                    if (item instanceof TrackGroup) {
                        ...
                        $track.append($('<span class="material-icons-outlined icon icon-not-played" />').text('play_arrow'));
                        $track.append($('<span class="material-icons-outlined icon icon-already-played" />').text('done'));
